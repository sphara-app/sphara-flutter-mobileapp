...
import 'new_meeting_invite_model.dart';
export 'new_meeting_invite_model.dart';

class NewMeetingInviteWidget extends StatefulWidget {
  const NewMeetingInviteWidget({Key? key}) : super(key: key);

  @override
  _NewMeetingInviteWidgetState createState() => _NewMeetingInviteWidgetState();
}

class _NewMeetingInviteWidgetState extends State<NewMeetingInviteWidget> {
  late NewMeetingInviteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewMeetingInviteModel());
