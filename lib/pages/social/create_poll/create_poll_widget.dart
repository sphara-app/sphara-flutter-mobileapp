                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        20.0, 0.0, 20.0, 0.0),
                                    child: Text(
                                      'Polls in quiz mode have one correct answer. users can\'t revoke their answer, good for educational purposes.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium,
                                    ),
                                  ),
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Who can share poll link?',
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                              FlutterFlowDropDown<String>(
                                controller: _model.dropDownValueController ??=
                                    FormFieldController<String>(null),
                                options: ['Only i can share it'],
                                onChanged: (val) =>
