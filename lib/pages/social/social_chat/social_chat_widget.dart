...
import 'social_chat_model.dart';
export 'social_chat_model.dart';

class SocialChatWidget extends StatefulWidget {
  const SocialChatWidget({Key? key}) : super(key: key);

  @override
  _SocialChatWidgetState createState() => _SocialChatWidgetState();
}

class _SocialChatWidgetState extends State<SocialChatWidget> {
  late SocialChatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SocialChatModel());
