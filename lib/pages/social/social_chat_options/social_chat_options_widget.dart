...
import 'social_chat_options_model.dart';
export 'social_chat_options_model.dart';

class SocialChatOptionsWidget extends StatefulWidget {
  const SocialChatOptionsWidget({Key? key}) : super(key: key);

  @override
  _SocialChatOptionsWidgetState createState() =>
      _SocialChatOptionsWidgetState();
}

class _SocialChatOptionsWidgetState extends State<SocialChatOptionsWidget> {
  late SocialChatOptionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SocialChatOptionsModel());
            ...
            children: [
              ...
              Align(
                ...
                child: wrapWithModel(
                  ...
                  child: SocialNavBarWidget(
                    nav: FFAppState().socialMenu,
                  ),
                ),
              ),
            ],
