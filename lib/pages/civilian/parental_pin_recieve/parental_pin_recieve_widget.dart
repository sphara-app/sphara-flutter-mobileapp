...
import 'parental_pin_recieve_model.dart';
export 'parental_pin_recieve_model.dart';
...
class _ParentalPinRecieveWidgetState extends State<ParentalPinRecieveWidget> {
  late ParentalPinRecieveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParentalPinRecieveModel());
  }
