      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('HostileSituation');
                      },
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 10.0, 0.0),
                            child: Text(
                              'There is an Active alert triggere by you to track \nthe status of that alert click here',
                              maxLines: 2,
            ...
            if (_model.settings)
              wrapWithModel(
                model: _model.homepagesettingsModel,
                updateCallback: () => setState(() {}),
