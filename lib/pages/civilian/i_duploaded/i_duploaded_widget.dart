...
import 'i_duploaded_model.dart';
export 'i_duploaded_model.dart';
...
class _IDuploadedWidgetState extends State<IDuploadedWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IDuploadedModel());
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              ...
              wrapWithModel(
                model: _model.uploadSuccessAlertModel,
