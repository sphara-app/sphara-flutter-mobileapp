...
import 'uploading_id_model.dart';
export 'uploading_id_model.dart';
...
class _UploadingIdWidgetState extends State<UploadingIdWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadingIdModel());

    _model.otherTextFieldController ??= TextEditingController();
                      ...
                      if ((_model.dropDownValue == 'Any Government ID') ||
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              20.0, 20.0, 20.0, 0.0),
                          child: TextFormField(
                            controller: _model.otherTextFieldController,
                            autofocus: true,
                            obscureText: false,
                            decoration: InputDecoration(
                              hintText:
                                  _model.dropDownValue == 'Any Government ID'
                                      ? 'Name of Government ID'
                                      : 'Name of Other Identification',
                            ...
                            validator: _model.otherTextFieldControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      Padding(
                                  ...
                                  builder: (context) {
                                    return GestureDetector(
                                      ...
                                      child: Padding(
                                        ...
                                        child: UploadSuccessAlertWidget(
                                          titleText:
