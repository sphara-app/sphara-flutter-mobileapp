...
import 'adding_participant_model.dart';
export 'adding_participant_model.dart';

class AddingParticipantWidget extends StatefulWidget {
  const AddingParticipantWidget({Key? key}) : super(key: key);

  @override
  _AddingParticipantWidgetState createState() =>
      _AddingParticipantWidgetState();
}

class _AddingParticipantWidgetState extends State<AddingParticipantWidget> {
  late AddingParticipantModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddingParticipantModel());
