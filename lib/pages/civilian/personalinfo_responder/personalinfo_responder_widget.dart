...
import 'personalinfo_responder_model.dart';
export 'personalinfo_responder_model.dart';
...
class _PersonalinfoResponderWidgetState
  ...
  late PersonalinfoResponderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PersonalinfoResponderModel());
