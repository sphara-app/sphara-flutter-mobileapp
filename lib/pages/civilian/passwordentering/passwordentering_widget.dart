...
import 'passwordentering_model.dart';
export 'passwordentering_model.dart';

class PasswordenteringWidget extends StatefulWidget {
  const PasswordenteringWidget({Key? key}) : super(key: key);

  @override
  _PasswordenteringWidgetState createState() => _PasswordenteringWidgetState();
}

class _PasswordenteringWidgetState extends State<PasswordenteringWidget> {
  late PasswordenteringModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PasswordenteringModel());
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: SelectionArea(
                                    child: Text(
                                  'Enter passcode to access your profile',
