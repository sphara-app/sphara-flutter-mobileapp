...
import 'resetpasscode_model.dart';
export 'resetpasscode_model.dart';

class ResetpasscodeWidget extends StatefulWidget {
  const ResetpasscodeWidget({Key? key}) : super(key: key);

  @override
  _ResetpasscodeWidgetState createState() => _ResetpasscodeWidgetState();
}

class _ResetpasscodeWidgetState extends State<ResetpasscodeWidget> {
  late ResetpasscodeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResetpasscodeModel());
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: SelectionArea(
                                    child: Text(
                                  'Enter your registered backup email id to\nreset your passcode',
