...
import 'uploadingidentification_model.dart';
export 'uploadingidentification_model.dart';
...
class _UploadingidentificationWidgetState
  ...
  late UploadingidentificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadingidentificationModel());
