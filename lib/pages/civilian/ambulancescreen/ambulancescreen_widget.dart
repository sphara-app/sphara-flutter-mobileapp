...
import 'ambulancescreen_model.dart';
export 'ambulancescreen_model.dart';
...
class _AmbulancescreenWidgetState extends State<AmbulancescreenWidget> {
  late AmbulancescreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AmbulancescreenModel());
              ...
              Align(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(20.0, 18.0, 20.0, 8.0),
