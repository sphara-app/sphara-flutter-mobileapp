...
import 'firehelp_confirmed_model.dart';
export 'firehelp_confirmed_model.dart';
...
class _FirehelpConfirmedWidgetState extends State<FirehelpConfirmedWidget> {
  late FirehelpConfirmedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FirehelpConfirmedModel());
  }
