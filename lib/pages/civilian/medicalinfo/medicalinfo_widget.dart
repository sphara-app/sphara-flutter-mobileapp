...
class MedicalinfoWidget extends StatefulWidget {
  const MedicalinfoWidget({Key? key}) : super(key: key);

  @override
  _MedicalinfoWidgetState createState() => _MedicalinfoWidgetState();
}
            ...
            Align(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    context.pushNamed('MedicalInsuranceCard');
                  },
                  child: Text(
                    'SKIP',
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            20.0, 5.0, 20.0, 0.0),
                        child: Text(
                          'List any condition which emergency responder needs to know.',
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Enter medical condition, if any?',
