...
import 'confirmingcode_model.dart';
export 'confirmingcode_model.dart';
...
class _ConfirmingcodeWidgetState extends State<ConfirmingcodeWidget> {
  late ConfirmingcodeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmingcodeModel());
  }
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('resendingcode');
                                      },
                                      child: Text(
                                        'NO',
                                        style: FlutterFlowTheme.of(context)
                                    ...
                                    InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('Enteringcode');
                                      },
                                      child: Text(
                                        'YES',
                                        style: FlutterFlowTheme.of(context)
