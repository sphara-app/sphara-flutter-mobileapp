...
export 'arrival_model.dart';

class ArrivalWidget extends StatefulWidget {
  const ArrivalWidget({Key? key}) : super(key: key);

  @override
  _ArrivalWidgetState createState() => _ArrivalWidgetState();
}

class _ArrivalWidgetState extends State<ArrivalWidget> {
  late ArrivalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArrivalModel());
  }
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        20.0, 20.0, 20.0, 0.0),
                                                child: Text(
                                                  'Need Resources, Contact closest responders for help!',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
