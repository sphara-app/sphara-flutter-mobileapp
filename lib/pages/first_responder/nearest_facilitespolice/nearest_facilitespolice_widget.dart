...
import 'nearest_facilitespolice_model.dart';
export 'nearest_facilitespolice_model.dart';
...
class _NearestFacilitespoliceWidgetState
  ...
  late NearestFacilitespoliceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NearestFacilitespoliceModel());
