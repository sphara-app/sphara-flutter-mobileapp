...
class RejectReasonWidget extends StatefulWidget {
  const RejectReasonWidget({Key? key}) : super(key: key);

  @override
  _RejectReasonWidgetState createState() => _RejectReasonWidgetState();
}
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Select from the pre-defined options if that was the reason of cancellation.',
