...
class MenuNewWidget extends StatefulWidget {
  const MenuNewWidget({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(70.0, 5.0, 0.0, 0.0),
                        child: Text(
                          '70% Completed',
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          if (FFAppState().responderMode == true) {
                            context.pushNamed(
                              'ResponderMainpage',
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          if (FFAppState().responderMode == true) {
                            context.pushNamed('ResponderEditProfile');
                          } else {
                            context.pushNamed(
                              'Profilesettings',
                              extra: <String, dynamic>{
                    ...
                    if (FFAppState().responderMode == false)
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 0.0, 0.0),
                        child: InkWell(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('AlertHistory');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          if (FFAppState().responderMode == true) {
                            context.pushNamed('ResponderSettings');
                          } else {
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('parentalplansubscribed');
                        },
                        child: Container(
                          width: double.infinity,
                          height: 55.0,
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          if (FFAppState().responderMode) {
                            setState(() {
                              FFAppState().responderMode = false;
                            });
                        ...
                        child: Container(
                          ...
                          height: 45.0,
                          decoration: BoxDecoration(
                            color: FFAppState().responderMode == false
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          if (!FFAppState().responderMode) {
                            ...
                            context.pushNamed('ResponderMainpage');
                          }
                        },
                        child: Container(
                          width: 150.0,
                          height: 45.0,
                          decoration: BoxDecoration(
                            color: FFAppState().responderMode == true
                                ? FlutterFlowTheme.of(context).primary
                                : Color(0x00000000),
                            borderRadius: BorderRadius.circular(40.0),
                          ),
