...
import 'addingnewcontact1_model.dart';
export 'addingnewcontact1_model.dart';
...
class _Addingnewcontact1WidgetState extends State<Addingnewcontact1Widget> {
  late Addingnewcontact1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Addingnewcontact1Model());
