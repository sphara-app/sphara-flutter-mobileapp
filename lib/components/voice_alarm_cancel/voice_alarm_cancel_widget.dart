...
import 'voice_alarm_cancel_model.dart';
export 'voice_alarm_cancel_model.dart';
...
class _VoiceAlarmCancelWidgetState extends State<VoiceAlarmCancelWidget> {
  late VoiceAlarmCancelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VoiceAlarmCancelModel());
  }
